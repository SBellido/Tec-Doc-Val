...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	/**
	* @brief En esta consulta se obtiene el reporte de los productos vendidos por día, detellando la fecha
	* la cantidad de productos vendidos, y el monto recaudado, guardando la información en un DTO
	* @param limit 
	*/
	@Query(value =""
	...
	/**
	* @brief Se consulta la tablas de cliente_producto y producto, el resultado obtenido
